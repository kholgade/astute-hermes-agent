...
def _make_multiplex_runner(monkeypatch):
    ...
    runner._profile_adapters = {
        "coder": {Platform.SLACK: secondary_adapter},
    }
...
def test_secondary_open_policy_not_authorized_by_default_allowlist(monkeypatch):
    ...
    assert runner._adapter_dm_policy(Platform.SLACK, profile="coder") == "open"
    assert runner._adapter_dm_policy(Platform.SLACK) == "allowlist"
